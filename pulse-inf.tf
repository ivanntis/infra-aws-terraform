...
resource "aws_iam_user" "pulse-api-user" {
    name = "pulse-api"
}
resource "aws_iam_group" "pulse-admin-api" {
  name = "pulse-admin-api"
}
...
resource "aws_iam_group_membership" "pulse-api-user-groups" {
    name    = "pulse-api-user-groups"
